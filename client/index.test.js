...
/* Okay so actually there is no need to use the ES6 module syntax (the import ... from ...) as you're not really importing anything anyway, so your tests are standalone. 
Thus going back to require I could just run the test file with npx jest.
